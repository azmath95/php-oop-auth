...
<?php if($user->is_admin(Session::get('username'))){?>
  <a style="color:#eee;margin-left:-215px;text-decoration: underline;" href="admin.php">Welcome Admin</a>
<?php } ?>
<?php } ?>
      <h1 class="judul"><strong>Hello <?php echo $user_data['username']; ?></strong></h1>
