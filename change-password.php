...
if( !$user->is_login() ){
  Session::flash('login', '<script>alert("Please Login")</script>');
  Redirect::to('login');
}
...
<h2 class="judul">Change Password</h2>
<form class="" action="change-password.php" method="post">
  <input type="password" class="bil" name="password" placeholder="Current Password "><br>
  <input type="password" class="bil" name="password_baru" placeholder="New Password"><br>
  <input type="password" class="bil" name="password_verify" placeholder="Repeat Password "><br>
  <input type="hidden" name="token" value="<?php echo Token::generate(); ?>">
  <input type="submit" class="tombol" name="submit" value="Submit Password">
